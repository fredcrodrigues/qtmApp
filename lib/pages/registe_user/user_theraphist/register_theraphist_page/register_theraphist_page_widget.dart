...
class RegisterTheraphistPageWidget extends StatefulWidget {
  const RegisterTheraphistPageWidget({super.key});

  @override
  State<RegisterTheraphistPageWidget> createState() =>
      _RegisterTheraphistPageWidgetState();
}

class _RegisterTheraphistPageWidgetState
    extends State<RegisterTheraphistPageWidget> {
  late RegisterTheraphistPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterTheraphistPageModel());
    ...
    _model.complemntController ??= TextEditingController();
    _model.complemntFocusNode ??= FocusNode();
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              '2s10qwmr' /* Insira seus dados cadastrais */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  ...
                                  child: Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode: _model.complemntFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: FFLocalizations.of(context)
                                              .getText(
                                            'f906z9rg' /* Complemento */,
                                          ),
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .bodyMedium
                            ...
                            onPressed: ((_model.complemntController.text ==
                                ...
                                : () async {
                                    ...
                                    await currentUserReference!
                                      ...
                                      cpf: _model.complemntController.text,
                                    ...
                                    context.goNamed('loading_page_user');
                                  },
