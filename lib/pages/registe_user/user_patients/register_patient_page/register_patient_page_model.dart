...
import 'dart:io';
import 'register_patient_page_widget.dart' show RegisterPatientPageWidget;
...
class RegisterPatientPageModel
    extends FlutterFlowModel<RegisterPatientPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (localidades)] action in register_patient_page widget.
  ...
  // State field(s) for complementPatient widget.
  FocusNode? complementPatientFocusNode;
  TextEditingController? complementPatientController;
  String? Function(BuildContext, String?)? complementPatientControllerValidator;
  ...
  void dispose() {
    ...
    complementPatientFocusNode?.dispose();
    complementPatientController?.dispose();
  }
