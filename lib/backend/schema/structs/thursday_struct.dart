...
class ThursdayStruct extends FFFirebaseStruct {
  ThursdayStruct({
    String? name,
    String? fieldOne,
    String? fieldTwo,
  ...
  static ThursdayStruct fromMap(Map<String, dynamic> data) => ThursdayStruct(
  ...
  static ThursdayStruct? maybeFromMap(dynamic data) =>
      data is Map ? ThursdayStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static ThursdayStruct fromSerializableMap(Map<String, dynamic> data) =>
      ThursdayStruct(
  ...
  @override
  String toString() => 'ThursdayStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ThursdayStruct &&
        name == other.name &&
...
ThursdayStruct createThursdayStruct({
  String? name,
  String? fieldOne,
  String? fieldTwo,
  String? fieldThree,
...
ThursdayStruct? updateThursdayStruct(
  ThursdayStruct? thursday, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    thursday
...
void addThursdayStructData(
  ...
  if (thursday.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && thursday.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final thursdayData = getThursdayFirestoreData(thursday, forFieldValue);
  final nestedData = thursdayData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = thursday.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getThursdayFirestoreData(
  ThursdayStruct? thursday, [
  bool forFieldValue = false,
]) {
  if (thursday == null) {
  ...
  final firestoreData = mapToFirestore(thursday.toMap());

  // Add any Firestore field values
  thursday.firestoreUtilData.fieldValues
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getThursdayListFirestoreData(
  List<ThursdayStruct>? thursdays,
) =>
    thursdays?.map((e) => getThursdayFirestoreData(e, true)).toList() ?? [];
