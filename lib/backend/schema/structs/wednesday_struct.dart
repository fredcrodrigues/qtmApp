...
class WednesdayStruct extends FFFirebaseStruct {
  WednesdayStruct({
    String? name,
    String? fieldOne,
    String? fieldTwo,
  ...
  static WednesdayStruct fromMap(Map<String, dynamic> data) => WednesdayStruct(
  ...
  static WednesdayStruct? maybeFromMap(dynamic data) => data is Map
      ? WednesdayStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static WednesdayStruct fromSerializableMap(Map<String, dynamic> data) =>
      WednesdayStruct(
  ...
  @override
  String toString() => 'WednesdayStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is WednesdayStruct &&
        name == other.name &&
...
WednesdayStruct createWednesdayStruct({
  String? name,
  String? fieldOne,
  String? fieldTwo,
  String? fieldThree,
...
WednesdayStruct? updateWednesdayStruct(
  WednesdayStruct? wednesday, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    wednesday
...
void addWednesdayStructData(
  ...
  if (wednesday.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && wednesday.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final wednesdayData = getWednesdayFirestoreData(wednesday, forFieldValue);
  final nestedData = wednesdayData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = wednesday.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getWednesdayFirestoreData(
  WednesdayStruct? wednesday, [
  bool forFieldValue = false,
]) {
  if (wednesday == null) {
  ...
  final firestoreData = mapToFirestore(wednesday.toMap());

  // Add any Firestore field values
  wednesday.firestoreUtilData.fieldValues
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getWednesdayListFirestoreData(
  List<WednesdayStruct>? wednesdays,
) =>
    wednesdays?.map((e) => getWednesdayFirestoreData(e, true)).toList() ?? [];
